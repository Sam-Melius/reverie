...
import { Network, CloudCog } from "lucide-react";

const services = [
  {
    title: "Standardized IT Across Multi-Location Venues",
    description:
      "Entertainment venues—whether cinemas, arcades, or event halls—need uniform tech setups to ensure smooth operations. We implement standardized, scalable systems to maintain consistency across all locations and enhance guest experiences. From synchronized digital signage to unified POS systems and network management, our solutions simplify IT oversight and reduce troubleshooting across branches.",
    icon: <Network className="w-7 h-7 text-[color:var(--accent-alt)]" />,
  },
  {
    title: "Scalable, Cloud-Based Infrastructure for Growth",
    description:
      "As your entertainment brand grows, your tech must scale with it. We deliver cloud-first infrastructure that enables seamless onboarding, centralized control, and secure data access across all venues—no matter where they're located. Our solutions support rapid expansion, reduce IT overhead, and future-proof your technology landscape with flexible, modular architecture.",
    icon: <CloudCog className="w-7 h-7 text-[color:var(--accent-alt)]" />,
  },
];
    ...
    <section className="relative w-full min-h-screen text-white px-6 lg:px-20 py-24 overflow-hidden">
      ...
      >
        <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-5xl font-extrabold tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-r from-[color:var(--accent-light)] via-[color:var(--accent)] to-[color:var(--accent-light)] drop-shadow-[0_0_10px_var(--accent-alt)] my-4"
          >
        ...
        />
        <motion.div className="text-xl md:text-2xl font-semibold  my-6 text-center">
