...
const services = [
  {
    title: "Dealership-Focused IT Infrastructure",
    description:
      "From showroom to service bay, we build IT systems that support every facet of your dealership. Ensure seamless connectivity across departments, secure payment processing, and stable POS systems.",
    icon: <Car className="w-7 h-7 text-[color:var(--accent-alt)]" />,
  },
  {
    title: "Secure & Streamlined Auto Service Systems",
    description:
      "Protect customer data, automate repair order workflows, and eliminate costly downtime. Our MSP solutions are tailored for DMS compatibility, diagnostics platforms, and more.",
  ...
  return (
    <section className="relative w-full min-h-screen text-white px-6 lg:px-20 py-24 overflow-hidden">
      ...
      <motion.div
        ...
        style={{ clipPath: "polygon(0% 0%, 85% 0, 100% 0%, 100% 90%)" }}
      />
      ...
      <motion.div
        ...
        style={{ clipPath: "polygon(0% 0%, 100% 100%, 100% 85%, 0% -15%)" }}
      />
      ...
      >
        ...
        >
          MSP Solutions for Auto Dealerships
        </motion.h1>
        <motion.div
        ...
        <p className="mt-4 text-white/80 text-lg max-w-3xl mx-auto mb-6">
          Dealerships depend on technology more than ever — from managing vehicle inventory to processing financing and keeping service operations efficient. Reverie Tech Solutions delivers managed IT services built specifically for the automotive industry. We ensure your systems stay fast, connected, and secure so you can focus on customer experience and sales.
        </p>
        <Link
          href="/contact"
        ...
        >
          Request a Dealership Assessment
        </Link>
      </motion.section>
      ...
      <motion.div
        ...
        style={{ clipPath: "polygon(0 0, 15% 100%, 100% 100%, 0% 0%)" }}
      />
      ...
      <motion.div
        ...
        style={{ clipPath: "polygon(100% 100%, 0% 0%, 0% 15%, 100% 115%)" }}
      />
    </section>
  );
}
