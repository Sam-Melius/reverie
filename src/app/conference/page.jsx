...
export default function AmadaConferencePage() {
  ...
  className="hidden md:block absolute top-20 right-0 w-64 h-64 bg-gradient-to-br from-[#00bfff] via-[color:var(--accent-light)] to-[color:var(--accent)] z-0"
  style={{
...
{/* <motion.div
  ...
  animate={{ opacity: 1, scale: 1 }}
  transition={{ delay: 0.5, duration: 0.6 }}
  className="hidden md:block absolute top-12 right-20 w-96 h-96 bg-gradient-to-br from-[color:var(--accent-light)] to-[color:var(--accent)] z-10"
  style={{
    clipPath: "polygon( 0% 10%, 100% 100%, 100% 60%, 0% -40%)",
  }}
/> */}
{/* <motion.div
  initial={{ opacity: 0, scale: 0.8 }}
  animate={{ opacity: 1, scale: 1 }}
  transition={{ delay: 0.5, duration: 0.6 }}
  className="hidden md:block absolute top-20 right-0 w-96 h-96 bg-gradient-to-br from-[color:var(--accent)] to-[color:var(--accent-dark)] z-10"
  style={{
    clipPath: "polygon( -15% -30%, 60% 100%, 100% 100%, 30% 0%)",
  }}
/> */}
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 m-12 relative z-10">
        {/* Logo & Tagline */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.4, duration: 0.5 }}
          className="mb-8 flex flex-col items-left"
        >
          <Image
        ...
        <motion.h1
          ...
          className="text-3xl text-[color:var(--accent)] font-semibold text-center mb-6"
        >
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-[color:var(--accent-light)]">WHY CHOOSE REVERIE TECH SOLUTIONS?</h2>
        ...
        <motion.div
          ...
          className="mb-8 text-white"
        >
          <h2 className="text-xl font-bold mb-2 text-[color:var(--accent-light)]">OUR COMMITMENT TO AMADA SENIOR CARE:</h2>
          <p>
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-[color:var(--accent-light)]">CONNECT WITH US</h2>
          <p className="mb-4">
  ...
  animate={{ y: 0, opacity: 1 }}
  transition={{ delay: 0.1, duration: 0.6 }}
  className="h-4 w-full absolute z-0 bottom-0 bg-gradient-to-bl from-[#00bfff] via-[color:var(--accent-light)] to-[color:var(--accent)]"
  style={{
...
/>
  ...
  animate={{ opacity: 1, scale: 1 }}
  transition={{ delay: 0.3, duration: 0.6 }}
  className="hidden md:block absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tl from-[#00bfff] via-[color:var(--accent-light)] to-[color:var(--accent)] z-0"
  style={{
