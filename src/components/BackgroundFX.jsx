  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(71, 241, 233, 0.93) 1px, transparent 1px), linear-gradient(to bottom, rgba(71, 241, 233, 0.93) 1px, transparent 1px)",
      ...
      {/* Radar sweep ring */}
      <div
        className="absolute top-1/2 left-1/2 w-[1000px] h-[1000px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[rgba(71, 241, 233, 0.93)]"
        animate={{ rotate: 360 }}
        transition={{ repeat: Infinity, duration: 60, ease: "linear" }}
      />

      {/* Scanlines */}
      <div className="absolute inset-0 bg-[repeating-linear-gradient(transparent,transparent_1px,rgba(71, 241, 233, 0.93)_1px)] z-[-1]" />
    </div>
  );
}
